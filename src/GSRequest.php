...
if (!function_exists('curl_init')) {
  throw new GSException('Gigya.Socialize needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
  throw new GSException('Gigya.Socialize needs the JSON PHP extension.');
}
...
class GSRequest {
    ...
    private function sendRequest($method,$domain,$path,GSObject $params,$token,$secret,$useHTTPS=false,$timeout=null,$userKey=null)
    {
    ...
    private function curl($url, GSObject $params, $timeout=null)
    {
        $postData = array();
     ...
     * @return string
     */
    public static function buildQS(GSObject $params)
    {
//        $val;
        $ret = "";
        foreach($params->getKeys() as $key)
    ...
    private static function calcOAuth1BaseString($httpMethod, $url, $isSecureConnection, GSObject $requestParams)
    {
